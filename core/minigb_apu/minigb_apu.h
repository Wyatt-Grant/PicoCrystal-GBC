...
/* PicoCrystal fix: minigb_apu.c is compiled as C (unmangled symbols), but
 * this project includes the header from C++ translation units too. Without
 * extern "C", the C++ compiler mangles the declarations here and the linker
 * can't match them to minigb_apu.c's definitions. */
#ifdef __cplusplus
extern "C" {
#endif
